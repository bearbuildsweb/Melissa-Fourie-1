  ...
  return (
    <>
      <header
        ...
        className="fixed top-0 left-0 right-0 z-40 bg-[#F2ECE6]/90 backdrop-blur-md py-4 sm:py-5 border-b border-[#E0D6CB] transition-all duration-300"
      >
        <div className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12 flex items-center justify-between">
          ...
          >
            <Logo size="md" sublineText="HAIR & MAKEUP ARTISTRY" sparkleArtistry />
          </a>
          ...
          <div className="flex items-center space-x-6 sm:space-x-8">
            ...
            {/* Bespoke Editorial Hamburger Icon inside Warm Taupe Pill / Depression (#B8A193) — Active on ALL Viewports */}
            <button

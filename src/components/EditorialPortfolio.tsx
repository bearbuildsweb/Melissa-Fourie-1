...
export const EditorialPortfolio: React.FC<EditorialPortfolioProps> = ({
  ...
  return (
    <section
      id="portfolio"
      className="py-20 lg:py-28 bg-[#F2ECE6] text-[#3E2023] overflow-hidden border-t border-[#DFD5CA]"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        {/* Minimal Editorial Quote Banner */}
        <div className="relative bg-[#FAF7F2] rounded-[2px] border border-[#DCD1C4] border-t-[#EFE8DE] border-b-[#C9BDAF] p-8 sm:p-12 flex flex-col sm:flex-row items-center justify-between gap-8 shadow-[0_1px_2px_rgba(46,24,27,0.04),0_5px_14px_-2px_rgba(46,24,27,0.05),0_18px_38px_-6px_rgba(46,24,27,0.07)] before:absolute before:inset-x-0 before:top-0 before:h-[1px] before:bg-gradient-to-r before:from-transparent before:via-white/80 before:to-transparent before:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-[1px] after:bg-[#C9BDAF]/70 after:pointer-events-none">
          <div className="space-y-1 text-center sm:text-left">
            <p className="font-serif text-2xl sm:text-3xl font-light text-[#3E2023] italic max-w-xl leading-relaxed">
              “An established legacy, trusted for life’s most defining moments.”
            </p>
            <p className="text-[11px] uppercase tracking-[0.2em] text-[#7A5F62] font-light">
              An international reputation rooted in Cape Town.
            </p>
          </div>
          ...
          <a
            ...
            className="px-8 py-4 bg-[#3E2023] text-[#F2ECE6] text-[11px] uppercase tracking-[0.24em] font-light hover:bg-[#4E2C30] transition-all duration-300 shrink-0 flex items-center space-x-2.5 group border border-[#3E2023] hover:border-[#C29A3A]/40 cursor-pointer"
          >
            <span>Meet Melissa</span>
            <ArrowUpRight className="w-3.5 h-3.5 text-[#C29A3A] transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
          </a>
        </div>
